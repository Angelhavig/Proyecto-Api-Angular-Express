...
exports.traceBlog = exports.linkBlog = exports.headBlog = exports.patchBlog = exports.putBlog = exports.postBlog = exports.deleteBlog = exports.getBlogE = exports.getBlog = exports.getBlogs = void 0;
...
const getBlog = (req, res) => {
    ...
    connection_1.default.query('SELECT * FROM blog WHERE id = ? and Titulo_Blog = ?', [id, titulo_Blog], (err, data) => {
        if (err) {
